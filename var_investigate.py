...
name = "Mahnaz"
grade = 11
favourite_exclamation = "yoo"
least_favourite_colour = "brown"
is_cool = True
math_test_score = 85.5
sister_name = "Parynaz"
friends_name = "Lauren"
Pets_name = "Prince"
...
# Processing / Output
print(
    f"Hey guys, my name is {name} and my sisters name is {sister_name} My dogs name is {Pets_name} I am currently in grade {grade}. "
